...
OnePatch accepts standard OTLP over HTTP — both `http/protobuf` (the OpenTelemetry SDK default) and `http/json` work, as does OTLP over gRPC. You do not need to change your exporter's protocol; the setup skill configures it for you.
